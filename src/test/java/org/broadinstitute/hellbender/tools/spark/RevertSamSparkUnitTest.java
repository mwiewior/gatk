...
public class RevertSamSparkUnitTest extends CommandLineProgramTest {
    ...
    public static void testGetDefaultExtension() {
        Assert.assertEquals(RevertSamSpark.getDefaultExtension(new GATKPathSpecifier("this.is.a.sam"), RevertSamSpark.FileType.dynamic), ".sam");
        Assert.assertEquals(RevertSamSpark.getDefaultExtension(new GATKPathSpecifier("this.is.a.cram"), RevertSamSpark.FileType.dynamic), ".cram"); //TODO https://github.com/broadinstitute/gatk/issues/5559
        Assert.assertEquals(RevertSamSpark.getDefaultExtension(new GATKPathSpecifier("this.is.a.bam"), RevertSamSpark.FileType.dynamic), ".bam");
        Assert.assertEquals(RevertSamSpark.getDefaultExtension(new GATKPathSpecifier("foo"), RevertSamSpark.FileType.dynamic), ".bam");
    }
