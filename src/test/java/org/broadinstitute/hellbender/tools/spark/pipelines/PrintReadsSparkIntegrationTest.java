...
public final class PrintReadsSparkIntegrationTest extends AbstractPrintReadsIntegrationTest {
    ...
    public void testReadAndWriteCRAMAndReferenceOnHDFS() throws Exception {
        ...
        MiniClusterUtils.runOnIsolatedMiniCluster(cluster -> {
            ...
            final List<GATKRead> localReads = readsSparkSource.getParallelReads(testCram.getURI().toString(), testRef).collect();
            final List<GATKRead> hdfsReads = readsSparkSource.getParallelReads(outputHDFSPath.getURI().toString(), testRef).collect();
